    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <section className="max-w-[960px] mx-auto px-4 md:px-6 lg:px-8 py-10">
        <div className="flex items-center justify-between">
          ...
          <Link to="/orders" className="text-sm font-semibold text-emerald-700 hover:text-emerald-800">
            View Orders
          </Link>
        </div>
        ...
        {!hasToken ? (
          <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-6">
            <p className="text-slate-600">Please sign in to view your account.</p>
            <button
              type="button"
          ...
          <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-6">
            {status === "loading" && <div className="text-slate-500">Loading profile...</div>}
            {status === "error" && (
